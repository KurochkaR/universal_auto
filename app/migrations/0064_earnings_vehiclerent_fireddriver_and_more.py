    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('checking', 'Перевіряється'), ('pending', 'Очікується'), ('completed', 'Виплачений'), ('failed', 'Не сплачений')], default='checking', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('earnings_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='app.earnings')),
        ...
        migrations.AddField(
            ...
            name='earnings_ptr',
            field=models.OneToOneField(auto_created=True, null=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=False, serialize=False, to='app.earnings'),
